odoo.define('control_budget.control_budget_widget', function
(require) {
    'use strict';
    ...
    var accountFinancialReportWidget = Widget.extend({
        events: {
            'click .o_control_budgets_web_action':
                'boundLink',
            'click .o_control_budgets_web_action_multi':
                'boundLinkmulti',
            'click .o_control_budgets_web_action_monetary':
                'boundLinkMonetary',
            'click .o_control_budgets_web_action_monetary_multi':
